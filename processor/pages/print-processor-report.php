...
$reportTitle = "Processor Report";
$type_map = [
    'all' => 'All Pending & Processed Requests',
    'pending' => 'All Pending Requests',
    'processed' => 'All Processed Requests',
    'claimed' => 'All Claimed Requests',
    'ready' => 'All Ready for Pickup Requests',
    'finished' => 'All Finished Requests',
];
$reportTitle = $type_map[$report_type] ?? 'Processor Report';
        ...
        <table>
            ...
            <tbody>
                <?php if (empty($requests)): ?>
                    <tr>
                        <td colspan="7" style="text-align:center; padding: 20px;">No records found for the selected criteria.</td>
                    </tr>
                <?php else: ?>
                    <?php foreach ($requests as $request): ?>
                        <tr>
                            <td><?= htmlspecialchars($request['id']) ?></td>
                            <td><?= htmlspecialchars($request['req_first_name'] . ' ' . $request['req_last_name']) ?></td>
